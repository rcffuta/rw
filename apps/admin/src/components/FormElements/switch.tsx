...
export function Switch({ background, withIcon, backgroundSize, name }: PropsType) {
	const id = useId()

	return (
		<label htmlFor={id} className="flex max-w-fit cursor-pointer select-none items-center">
