    ...
    return (
        <ShowcaseSection title="Add New Product" className="!p-6.5">
            ...
            <InputGroup
                ...
                handleChange={(e) =>
                    productStore.setField("title", e.target.value)
                }
            ...
            <CategorySelect
                ...
                handleChange={(e) =>
                    productStore.setField("category", e.target.value)
                }
            />
            ...
            <TextAreaGroup
                ...
                handleChange={(e) =>
                    productStore.setField("description", e.target.value)
                }
            />
            ...
            <div className="mb-4.5 flex flex-col gap-4.5 xl:flex-row">
                <InputGroup
                    ...
                    handleChange={(e) =>
                        productStore.setField("price", e.target.value)
                    }
                />
                ...
                <InputGroup
                    ...
                    handleChange={(e) =>
                        productStore.setField("discountPrice", e.target.value)
                    }
                />
            </div>
        </ShowcaseSection>
