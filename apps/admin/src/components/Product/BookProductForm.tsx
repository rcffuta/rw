	...
	return (
		<ShowcaseSection title="Enter Book Product Info" className="!p-6.5">
			<InputGroup
				...
				handleChange={(e) => productStore.setField('author', e.target.value)}
				required
			/>
			...
			<InputGroup
				...
				handleChange={(e) => productStore.setField('bookGenre', e.target.value)}
				required
			/>
			...
			<InputGroup
				...
				handleChange={(e) => productStore.setField('language', e.target.value)}
				required
			/>
			...
			<div className="mb-4.5 flex flex-col gap-4.5 xl:flex-row">
				<InputGroup
					...
					handleChange={(e) => productStore.setField('isbn', e.target.value)}
					required
				/>
				...
				<InputGroup
					...
					handleChange={(e) => productStore.setField('pages', e.target.value)}
					required
				/>
			</div>
		</ShowcaseSection>
