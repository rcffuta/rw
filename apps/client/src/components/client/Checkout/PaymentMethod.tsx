        ...
        <div className="flex flex-col gap-3">
            ...
            >
              <div className="flex items-center">
                <div className="pr-2.5">
                  <Image src="/assets/checkout/bank.svg" alt="bank" width={29} height={12}/>
                </div>
          ...
          >
            ...
            >
              <div className="flex items-center">
                <div className="pr-2.5">
                  <Image src="/assets/checkout/cash.svg" alt="cash" width={21} height={21} />
                </div>
          ...
          >
            ...
            >
              <div className="flex items-center">
                <div className="pr-2.5">
                  <Image src="/assets/checkout/paypal.svg" alt="paypal" width={75} height={20}/>
                </div>
