            ...
            <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
                <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
                    <div className="text-center">
                        ...
                        <div className="mt-4">
                            <button
                                onClick={() => toast.custom("Not implemented!")} // Try to recover
                                className="inline-flex items-center gap-2 font-medium text-blue bg-blue-light-5 py-3 px-6 rounded-md ease-out duration-200 hover:bg-blue-dark hover:text-white"
                            >
                                Try Again
                            </button>
